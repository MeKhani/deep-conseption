...
# print(en_dic_id)
graph = add_feature_to_graph(graph,i_r,en_dic_id, num_relations)
print(graph.ndata["feat"][176])
print(graph.ndata["feat"][179])
print(graph.ndata["feat"][180])
print(graph.ndata["feat"][181])
print(graph.ndata["feat"][182])
print(graph.ndata["feat"][183])
